...
class ArticleController extends BaseController
{
    ...
    {
        if (!$this->authUser->can('add articles')) {
    ...
    {
        if (!$this->authUser && $article->state->key != 'publish') {
    ...
    {
        if (!$this->authUser->can('edit articles')) {
            return parent::abortUnauthorized();
        }

        if($this->authUser->id !== $article->created_by_id && !$this->authUser->can('update others articles')) {
            return parent::abortUnauthorized();
        }
    ...
    public function clap(Article $article)
    {
        ...
        if($this->authUser->id == $article->created_by_id && !$this->authUser->can('clap own articles')) {
